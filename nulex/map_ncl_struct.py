...
def main():
    ...
    reg_mode = argv[argv.index("--reg") + 1] if "--reg" in argv else "sync"   # sync (ncl_dff) | qdi (ncl_reg bank)
...
def emit_vhdl(top, ports, dual_nets, clock_nets, minterm_sigs, body, extra_ports):
