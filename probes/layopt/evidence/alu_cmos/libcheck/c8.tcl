...
set_power_activity -input_port A0 -activity 1.0 -duty 0.5
set_power_activity -input_port A1 -activity 0.0 -duty 0.0
set_power_activity -input_port S -activity 0.0 -duty 0.0
puts "@@@CELL sg13g2_mux2_1 arc=A0->X CL=5.66 slew=75.6"
