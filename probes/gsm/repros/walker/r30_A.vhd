...
-- right.  Variant A: v_unpacked_exp_s0 := (sv2v_cast_36466(resize(src_exp_raw, 12)) - src_bias_s) + sv2v_cast_36466(resize((L3D_0 & fclass(4)), 12))
...
architecture from_verilog of r30_A is
